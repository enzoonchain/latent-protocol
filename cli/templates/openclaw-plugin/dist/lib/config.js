...
function readLatentConfigFile() {
    ...
    for (const p of paths) {
        try {
            ...
            if (typeof raw.min_payout === "number")
                out.minPayout = raw.min_payout;
            if (typeof raw.minPayout === "number")
                out.minPayout = raw.minPayout;
            return out;
        }
        catch {
            // try next
